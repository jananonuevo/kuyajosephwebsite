function ContactInfo() {
  ...
  <div className = ""> 
    ...
    <div className = "px-5 sm:px-30 grid gap-20 sm:grid-cols-1 xl:grid-cols-2 md:items-center lg:items-center text-center mt-10">
      ...
      <div className = "">
        ...
        <p className="text-center mx-3 mt-3">Reach out through my phone number which is also available via Viber or WhatsApp</p>
        <p className="text-center mx-3 mt-3 underline">+63 955 866 1262</p>
      </div>      
      ...
      <div className = "">
        ...
        <p className="text-center mx-3 mt-3">We can also communicate through my email, which is my main mode of communication should you wish to have a copy of the computations and brochures</p>
        <p className="text-center mx-3 mt-3 underline">hello123.alveoland@gmail.com</p>
      </div>   
