function GeneralInfo() {
  ...
  return (
    ...
    <div className = "grid gap-20 xs:grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 text-center mt-10 mb-50 text-[#444444]">
      <div className = "mx-10">
        <h1 className="text-center font-bold text-9xl mt-5">35</h1>
        <p className="text-center mx-5 mt-3 text-2xl"> No. of Floors</p>
      </div>      
      
      <div className = "mx-10">
        <h1 className="text-center font-bold text-9xl mt-5">2029</h1>
        <p className="text-center mx-5 mt-3 text-2xl">Turnover Year</p>
      </div> 

      <div className = "mx-10">
        <h1 className="text-center font-bold text-9xl mt-5">7</h1>
        <p className="text-center mx-5 mt-3 text-2xl">Podium Parking Levels</p>
      </div>   

      <div className = "mx-10">
        <h1 className="text-center font-bold text-9xl mt-5">4</h1>
