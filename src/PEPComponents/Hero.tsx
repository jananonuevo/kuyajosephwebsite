...
const Hero = ({ openModal }: HeroProps) => {
  ...
  return (
    ...
    <div className="relative w-full min-h-screen bg-[url(./public/PEPhero.jpg)] bg-no-repeat bg-cover bg-center">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-10 text-white">
        ...
        <div className="">
          ...
          <h1 className="text-center font-bold text-2xl sm:text-4xl md:text-5xl lg:text-6xl">Park East Place by Alveo</h1>
